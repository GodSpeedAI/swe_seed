...
Use this hook prompt when lifecycle context matches: learning, lesson, postmortem, memory update, reflection.

## What to do

Require the agent to pursue: record only durable, evidence-backed lessons that improve future agent decisions without creating memory bloat.
